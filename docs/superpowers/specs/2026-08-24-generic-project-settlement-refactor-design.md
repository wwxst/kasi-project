...
当前优先完成短剧 `CPS`：补齐 GoodShort 订单同步、推广归因、历史费率快照、佣金明细、月度账单和结算查询。CapCut、CPA、CPM、通用项目管理和甲方 API 数据源暂缓，不属于本轮实施范围。具体改造边界见[短剧 CPS 完整化范围与重构边界](2026-08-24-short-drama-cps-completion-scope.md)。
