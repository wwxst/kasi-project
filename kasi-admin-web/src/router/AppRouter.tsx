...
const PromotionLinkPage = lazy(() =>
  import('../pages/promotion/PromotionLinkPage').then((module) => ({
    default: module.PromotionLinkPage,
  })),
)
const PromotionProjectPage = lazy(() =>
  import('../pages/promotion/PromotionProjectPage').then((module) => ({
...
const DramaCatalogSyncPage = lazy(() =>
  import('../pages/drama/DramaSyncCenterPage').then((module) => ({
    default: module.DramaCatalogSyncPage,
  })),
)
const DramaContentSyncPage = lazy(() =>
  import('../pages/drama/DramaSyncCenterPage').then((module) => ({
    default: module.DramaContentSyncPage,
  })),
)
...
const SmsConfigPage = lazy(() =>
  import('../pages/system/SmsConfigPage').then((module) => ({
    default: module.SmsConfigPage,
  })),
)
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            <Route element={<AdminLayout />}>
              ...
              <Route
                path="/drama/sync/catalog"
                element={<DramaCatalogSyncPage />}
              />
              <Route
                path="/drama/sync/content"
                element={<DramaContentSyncPage />}
              />
              <Route
