...
(
    ...
    `updated_at`           DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY `idx_promotion_project_type_id` (`project_type_id`),
...
CREATE TABLE `promotion_link` (
    ...
    UNIQUE KEY `uk_promotion_link_external_identity` (`connection_id`, `drama_id`, `user_id`, `media_type`, `external_code`, `link_variant`),
