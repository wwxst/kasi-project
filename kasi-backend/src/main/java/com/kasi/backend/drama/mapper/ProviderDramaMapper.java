...
public interface ProviderDramaMapper {
    ...
    long countPublished(@Param("language") String language);
    List<ProviderDrama> pagePublished(@Param("language") String language, @Param("offset") int offset, @Param("size") int size);
}
