...
public interface ProviderDramaMapper {
    ...
    long countPublished(@Param("title") String title, @Param("language") String language);
    List<ProviderDrama> pagePublished(@Param("title") String title, @Param("language") String language,
                                      @Param("offset") int offset, @Param("size") int size);
}
