...
@Service
public class AesGcmProviderCredentialCipher implements ProviderCredentialCipher {
    ...
    private static final String DECRYPTION_FAILURE_MESSAGE = "平台密钥无法解密";

    private final SecretKeySpec masterKey;
    private final SecureRandom secureRandom = new SecureRandom();

    public AesGcmProviderCredentialCipher(ProviderCredentialProperties properties) {
    ...
    public String encrypt(String plaintext) {
        if (plaintext == null || plaintext.isBlank()) {
            throw new IllegalArgumentException("平台密钥不能为空");
        }
        ...
        try {
            ...
            throw new IllegalStateException("平台密钥无法加密");
        }
    }
