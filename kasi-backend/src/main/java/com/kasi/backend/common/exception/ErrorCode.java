...
public enum ErrorCode {
    ...
    VERIFICATION_CODE_SEND_FAILED(4005, "验证码发送失败，请稍后重试"),
    ...
    PROMOTION_LINK_EXTERNAL_CODE_CONFLICT(7026, "同一推广身份的推广口令不一致"),
    ...
    PROMOTION_PROJECT_TYPE_NOT_FOUND(7022, "项目类型不存在"),
    PROMOTION_PROJECT_TYPE_CODE_EXISTS(7023, "项目类型编码已存在"),
    PROMOTION_PROJECT_TYPE_IN_USE(7024, "项目类型已被项目使用，不能删除"),
    PROMOTION_PROJECT_TYPE_DISABLED(7025, "项目类型已停用"),
