...
class PromotionOrderServiceTest {
    ...
    @Test
    @DisplayName("订单状态仅包含已支付和已退款")
    void orderStatusContainsOnlyPaidAndRefunded() {
        assertThat(PromotionOrderStatus.values())
                .containsExactly(PromotionOrderStatus.UNPAID, PromotionOrderStatus.PAID,
                        PromotionOrderStatus.REFUNDED, PromotionOrderStatus.UNKNOWN);
    }
